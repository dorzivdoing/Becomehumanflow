          ...
          <div style={{ display: 'flex', gap: '40px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '240px' }}>
              {[
                ...
                'מחוץ לקליניקה, החקירה העצמית שלי מלווה בחיבור יומיומי לאדמה וליצירה: אני לומד על חיבור לאדמה דרך לימודי חקלאות יצרנית בקנה מידה קטן, מתסיס ירקות ומשמר מזון, חוקר תנועה ממוקדת ברקמת הפאשיה ומוצא עוגן והשראה במוזיקה, שירה ובשפת הציפורים.',
